...
The goal was to move beyond surface-level reporting and answer real business questions: Which stores are underperforming? Which products generate the most warranty claims? Where is revenue growing — and where is it declining? What does warranty behaviour tell us about product reliability?
...
- **SQL** — Joins, CTEs, Subqueries, Window Functions, 
  LAG/LEAD, RANK, time-series analysis
